...
> 本页为历史课程感想收集材料，未纳入 2026 ICS-PA 讲义。原有的 FTP 提交地址、账号、密码和截止时间均已失效；实验代码提交请遵循 [PA0.6](PA0.6.md) 中的 `make submit` 说明。
...
本节原有的 FTP 提交信息属于旧版课程材料，不适用于 2026 ICS-PA；请勿按其中信息提交。

### 截止时间

本页为历史材料，未提供当前课程的截止时间。
